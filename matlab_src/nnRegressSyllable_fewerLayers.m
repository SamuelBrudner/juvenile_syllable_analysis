function [syllNet_age2latent,tr_a2l,syllNet_latent2age,tr_l2a] = nnRegressSyllable_fewerLayers(ageIn,segIn,latentIn,holdout_ranges)
...
syllNet_latent2age = fitnet([16 4],'trainbr');

syllNet_latent2age.trainParam.time = 1800; % Do not train more than 30 min
syllNet_latent2age.trainParam.max_fail = 3;
syllNet_age2latent.trainParam.time = 1; % This model isn't used, just train for 1 sec
